  ...
  return (
    <article className="max-w-3xl mx-auto px-6 pt-8 pb-32">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-muted-foreground mb-16">
        ...
        <p>
          Each collection is released in small batches, and many pieces are made to order. We believe in making less and making it well. When you wear Miracle Collections, you carry with you the rhythm of the needles, the texture of the yarn, and the intention of a maker who cared about every single stitch.
        </p>
      </div>

      {/* Attribution */}
      <p className="text-sm text-muted-foreground">
        Apparel & Footwear by Miracle Collections
      </p>
    </article>
  );
}
